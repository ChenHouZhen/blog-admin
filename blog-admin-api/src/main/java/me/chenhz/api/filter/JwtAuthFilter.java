package me.chenhz.api.filter;


import me.chenhz.api.config.JWTToken;
...
public class JwtAuthFilter extends AuthenticatingFilter {
    ...
    protected boolean isAccessAllowed(ServletRequest request, ServletResponse response, Object mappedValue) {
        ...
        if ("dev".equals(profile)){
            // eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJleHAiOjE2MDQ4MjcwNzYsImlhdCI6MTYwNDgyMzQ3NiwidXNlcm5hbWUiOiJhZG1pbiJ9.PSjqB2eD9P2-o7c23SjloOhrAW1NcHUrQpl7q-zEcX4
        ...
        try {
            ...
            log.error("Not found any token.{}", httpRequest.getRequestURI());
        }catch (Exception e) {
